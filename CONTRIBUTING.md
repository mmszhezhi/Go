...
Welcome to [TheAlgorithms/Go](https://Go)! Before submitting pull requests, please make sure that you have **read the whole guidelines**. If you have any doubts about this contribution guide, please open [an issue](https://Go/issues/new/choose) or ask in our [Discord server](https://the-algorithms.com/discord/) / [Gitter](https://gitter.im/TheAlgorithms), and clearly state your concerns.
...
Please check the [`CODEOWNERS`](https://Go/blob/master/.github/CODEOWNERS) file for a list of repository maintainers.
...
- Your work will be distributed under the [MIT License](https://Go/blob/master/LICENSE) once your pull request has been merged.
...
- Do not update [`README.md`](https://Go/blob/master/README.md) along with other changes. First, create an issue and then link to that issue in your pull request to suggest specific changes required to [`README.md`](https://Go/blob/master/README.md).
...
- Check out our [pull request template](https://Go/blob/master/.github/PULL_REQUEST_TEMPLATE/pull_request.md
  )

#### Building Locally

Before submitting a pull request, [build the code locally](#building) or using the convenient [![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://Go) service.
